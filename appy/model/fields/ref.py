...
class Ref(Field):
    ...
    pxObjectActions = Px('''
     <div var="showActions=ifield.getAttribute(io, 'showActions')"
      ...
      <div if="editable and not popup and not inCell" class="ibutton"
           var2="text=o.class_.getTextFor(o, 'edit')">
       <a if="not locked"
    ...
    def __init__(self, class_=n, attribute=n, validator=n, composite=False,
      ...
      writePermission='write', width=n, height=5, maxChars=n, colspan=1,
      master=n, masterValue=n, masterSnub=n, focus=False, historized=False,
      mapping=n, generateLabel=n, label=n, queryable=False, queryFields=n,
      queryNbCols=1, searches=n, navigable=False, changeOrder=True,
      numbered=False, checkboxes=True, checkboxesDefault=False, sdefault='',
      scolspan=1, swidth=n, sheight=n, fwidth='7em', fheight='14em', sselect=n,
      fselect=n, persist=True, render='list', renderMinimalSep=', ', target=n,
      listCss=n, menuIdMethod=n, menuInfoMethod=n, menuUrlMethod=n, menuCss=n,
      dropdownCss=n, menuItemWrap=False, view=n, cell=n, buttons=n, edit=n,
      custom=n, xml=n, translations=n, showActions='all',
      actionsDisplay='block', showGlobalActions=True, collapsible=False,
      titleMode='link', viewAdded=True, noValueLabel='choose_a_value',
      noValueFirst=True, noObjectLabel='no_ref',
