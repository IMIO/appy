...
class Legend:
    ...
    def getEntryNameFor(self, obj, eventType, allEventNames):
        '''Get the name of the legend entry corresponding to this p_eventType'''
        method = self.entryName
        if method:
            r = method(obj, eventType, allEventNames)
        else:
    ...
    def getEntries(self, field, obj, allEventTypes, allEventNames, url, _,
        ...
        for eventType in allEventTypes:
            ...
            if style not in byStyle:
                entryName = self.getEntryNameFor(obj, eventType, allEventNames)
                entry = Object(name=entryName, content='', style=style)
                r.append(entry)
                byStyle[style] = entry
        ...
        # the timeline cell.
        r.append(Object(name=_('several_events'), content='',
        ...
        if self.update: self.update(obj, r)
        return r
