...
class Pod(Field):
    ...
    def __init__(self, validator=None, show=('view', 'result'), page='main',
      ...
      stylesMapping={}, stylesOutlineDeltas=None, formats=None, getChecked=None,
      mailing=None, mailingName=None, showMailing=None, mailingInfo=None,
      view=None, cell=None, edit=None, xml=None, translations=None,
      downloadName=None, downloadDisposition='attachment', forceOoCall=False,
    ...
    def getVisibleTemplates(self, obj):
        ...
        if not self.showTemplate:
            ...
            for template in self.template:
                formats = self.getVisibleFormats(obj, template)
