...
class Renderer:
    ...
    def __init__(self, template, context, result, pythonWithUnoPath=None,
      ...
      protection=False, pageStart=1, tabbedCR=False, fonts=None, loPool=None):
        ...
        #
        # In order to do so, pass, in arg p_evaluator, an instance of class
        # appy.pod.restricted.Evaluator. For more information and options,
        ...
        # If you want to enable this evaluator, place, in arg p_evaluator, an
        # instance of class appy.pod.evaluator.Compromiser. For more information
        # and options, consult appy/pod/evaluator.py.

        # Finally, you can also choose to implement your own evaluator, by
        # creating your own sub-class of class appy.pod.evaluator.Evaluator and
        # by passing an instance of it in the p_evaluator arg. Consult class
        # Evaluator in appy/pod/evaluator.py for details about the methods you
        # need to implement.
